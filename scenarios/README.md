...
- **Phase 1 load / stress** (orchestrator pipeline, gateway workload):
  ...
  - [`phase1_load_burst_all_fault_variants_no_pod_pause.yaml`](phase1_load_burst_all_fault_variants_no_pod_pause.yaml) — burst + `fault_rps` + all non-`pod_pause` Phase 1 pod fault variants.
